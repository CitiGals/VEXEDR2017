...
task autonomous()
{
  // ..........................................................................
	...
	//motor [mobileLift] = -FULLPWR;
	//wait1Msec(400);
	frontDrive(FULLPWR, 9000); //MUST STILL TEST TIME AND POWER
	//startTask( mobileHook );
	//mobileLiftOnly(FULLPWR, 1000);
	//frontDrive(-FULLPWR, 4000);
/*frotDrive(-FULLPWR, 2000);
	sideDriveGoal(FULLPWR, 700);
	//wait1Msec(500);
	//startTask( mobileHook );
	mobileLiftOnly(FULLPWR, 550);
  turnNinetyNinety(HALFPWR, 500); //TEST TIME
  sideDrive(FULLPWR, 1000);
  //wait1Msec(500);
  //startTask (mobileHookTwo);
  mobileLiftOnly(-FULLPWR,200);
  turnNinetyNinety(-FULLPWR, 500);
  sideDrive(-FULLPWR, 1000);
*/
