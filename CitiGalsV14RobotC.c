#pragma config(Sensor, in1,    potentialArm,   sensorPotentiometer)
...
//YOOOOOOO POTENTIOMETER LIMITS ARE: 0 TO 4095
//max for bot 4095
//min for bot 1095
//goal for bot 1331
//get jordan to reattach in new orientation and retest
...
*/
	  ...
	  {
		 motor[arm] = -HALFPWR; //claw moves in opposite direction when button 7L pressed
  	}
		else
		{
			motor [arm] = 0;
	  ...
	  {
	  		motor[claw] = HALFPWR; //arm moves in opposite direction when button 7L pressed
  	}
		else
		{
			motor [claw] = 0;
    ...
    else if (vexRT[Btn7R] == 1) //if 6D is pressed then scissor lift down
    {
